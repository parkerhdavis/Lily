	...
	// ── Tab: Assignments & Decisions ─────────────────────────────────────
	{
		...
		questions: [
			...
			},
			{
				...
				variableMappings: {
					"Healthcare POA Alternate Agent Full Name": "full_name",
					"Healthcare POA Alternate Agent Phone": "phone",
					"Healthcare POA Alternate Agent Address": "address",
					"Healthcare POA Alternate Agent City": "city",
					"Healthcare POA Alternate Agent State": "state",
					"Healthcare POA Alternate Agent Zip": "zip",
				},
			},
			{
				kind: "contact-role",
				role: "Healthcare POA Third Agent",
				label: "Third Healthcare POA Agent",
				variableMappings: {
					"Healthcare POA Third Agent Full Name": "full_name",
					"Healthcare POA Third Agent Phone": "phone",
					"Healthcare POA Third Agent Address": "address",
					"Healthcare POA Third Agent City": "city",
					"Healthcare POA Third Agent State": "state",
					"Healthcare POA Third Agent Zip": "zip",
				},
			},
		],
	},
